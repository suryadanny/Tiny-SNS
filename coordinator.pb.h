...
template <>
::csce438::FollowRequest* Arena::CreateMaybeMessage<::csce438::FollowRequest>(Arena*);
template <>
...
class FollowRequest final :
 ...
 public:
  ...
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR FollowRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  FollowRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const FollowRequest& from) {
    FollowRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void clear_user1() ;
  ::int32_t user1() const;
  void set_user1(::int32_t value);

  private:
  ::int32_t _internal_user1() const;
  void _internal_set_user1(::int32_t value);

  public:
  // int32 user2 = 2;
  void clear_user2() ;
  ::int32_t user2() const;
  void set_user2(::int32_t value);

  private:
  ::int32_t _internal_user2() const;
  void _internal_set_user2(::int32_t value);
...
inline ::int32_t FollowRequest::user1() const {
  // @@protoc_insertion_point(field_get:csce438.FollowRequest.user1)
  return _internal_user1();
}
inline void FollowRequest::set_user1(::int32_t value) {
  _internal_set_user1(value);
  // @@protoc_insertion_point(field_set:csce438.FollowRequest.user1)
}
inline ::int32_t FollowRequest::_internal_user1() const {
  return _impl_.user1_;
}
inline void FollowRequest::_internal_set_user1(::int32_t value) {
  ;
  _impl_.user1_ = value;
}
...
inline ::int32_t FollowRequest::user2() const {
  // @@protoc_insertion_point(field_get:csce438.FollowRequest.user2)
  return _internal_user2();
}
inline void FollowRequest::set_user2(::int32_t value) {
  _internal_set_user2(value);
  // @@protoc_insertion_point(field_set:csce438.FollowRequest.user2)
}
inline ::int32_t FollowRequest::_internal_user2() const {
  return _impl_.user2_;
}
inline void FollowRequest::_internal_set_user2(::int32_t value) {
  ;
  _impl_.user2_ = value;
}
